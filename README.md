...
* Superposition d'image 
    * Image envoyé en direct (Si SVG)
    * Image via Blob (OK)
    * Image vers Url (OK)
* Génération depuis un Seed et une configuration
    * Gestion du seed (OK)
    * Gestion de layer lié (OK)
* Gestion de format d'image
    * svg (OK)
    * png (OK)
    * webp
* Pour la génération
    * Il faut un format manipulable, et tel quel on renvoie directement un élément intégrable via React, ça peut suffir d'après moi (Semble OK mais à valider)
* Configuration
    * Décalage X/Y
    * Width et height par layer
